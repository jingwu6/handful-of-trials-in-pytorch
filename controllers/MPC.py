...
from .optimizers.cem import CEMOptimizer
...
class MPC(Controller):
    ...
    def train(self, obs_trajs, acs_trajs, rews_trajs):
        # obs size (1001,26); ac size(1000,6); rewards size (1000,1) ;
        ...
        Returns: None.
        """
        # print('start training the controller')
        ...
        for obs, acs in zip(obs_trajs, acs_trajs):
            ...
            # print(new_train_in[0].shape, new_train_targs[0].shape)
        ...
        # (1000, 26)
        # (150,11)
        print(self.train_targs.shape)
        # Train the model
        self.has_been_trained = True

        # get the mean and variance of input data in row
        # if the variance is too small set it to 1
        ...
        for i in epoch_range:
            for batch_num in range(num_batch):
                ...
                # (5, 32) first dimension gives how many 2by2 matrix, the second dimension gives the index of rows
                ...
                # torch.Size([5, 32, 32]) torch.Size([5, 32, 26])
    ...
    def act(self, obs, t, get_pred_cost=False):
        ...
        self.sy_cur_obs = obs
        # pre_sol (180,) (180,)
        # print('pre_sol', self.prev_sol.shape, self.init_var.shape)
    ...
    def _compile_cost(self, ac_seqs):
        ...
        # Before, ac seqs has dimension (500, 180) which are pop size and sol dim coming from CEM
        ac_seqs = ac_seqs.view(-1, self.plan_hor, self.dU)
        #  After, ac seqs has dimension (500, 30, 6)
        ...
        # tiled torch.Size([30, 500, 20, 6])

        # Then, (25, 400, 20, 1)
        # ac_seqs torch.Size([30, 10000, 6])
        ...
        '''currO1 (26,)
        currO2 torch.Size([1, 26])
        currO3 torch.Size([10000, 26])
        '''
